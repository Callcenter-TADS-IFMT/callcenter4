<div class="list-group" style="width: 200px;margin-top: 25px">
    ...
    <a href="./fila-atendimento.php" class="list-group-item ">
        <span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> Fila de Chamados</a>
    <a href="./novo-usuario.php" class="list-group-item ">
        <span class="glyphicon glyphicon-user" aria-hidden="true"></span> Cadastro de Usuários</a>
